...
import { Sparkles, Mail, Lock, Eye, EyeOff, ArrowRight, Brain, Heart, Shield, User, AlertCircle } from "lucide-react"
import { useRouter } from "next/navigation"
import { useAuth } from "@/lib/hooks/useAuth"

export default function AuthPage() {
  const router = useRouter()
  const { user, loading, error, login, register, clearError, isAuthenticated } = useAuth()
